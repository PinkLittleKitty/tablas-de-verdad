function build() {
    ...
    if (text.match(/[^ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01+'() ]/g) != null) {
        placeholder.innerHTML = "<p>Uno de los caracteres no está permitido.</p>";
        return;
    }
    text = text.replace(/ /g, '');
    ...
    if (variables.length > 8) {
        placeholder.innerHTML = "<p>Solo podes tener 8 variables.</p>";
        return;
    }
    let string = "<tr><th style=\"letter-spacing: 0; padding: initial;\">Número</th>";
    ...
    if (string.indexOf("<td></td>") == -1)
        ...
        placeholder.innerHTML = "<p>Expresión inválida.</p>";
